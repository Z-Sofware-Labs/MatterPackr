...
- **Windows NSIS Installer**: `src-tauri/target/release/bundle/nsis/MatterPackr_1.0.0_x64-setup.exe`
- **Windows MSI Package**: `src-tauri/target/release/bundle/msi/MatterPackr_1.0.0_x64_en-US.msi`
