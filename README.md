...
| :--- | :--- | :--- | :--- |
| **Windows** | 64-bit (`x64`) | [**MatterPackr Setup (.exe)**](https://github.com/Z-Sofware-Labs/MatterPackr/releases/latest/download/MatterPackr_1.0.5_x64-setup.exe) | NSIS Installer |
| **Windows** | 64-bit (`x64`) | [**MatterPackr Package (.msi)**](https://github.com/Z-Sofware-Labs/MatterPackr/releases/latest/download/MatterPackr_1.0.5_x64_en-US.msi) | MSI Installer |
| **macOS** | Universal (`Apple Silicon & Intel`) | [**MatterPackr DMG (.dmg)**](https://github.com/Z-Sofware-Labs/MatterPackr/releases/latest/download/MatterPackr_1.0.5_universal.dmg) | Universal Disk Image |
| **Linux** | 64-bit (`x86_64`) | [**MatterPackr AppImage (.AppImage)**](https://github.com/Z-Sofware-Labs/MatterPackr/releases/latest/download/MatterPackr_1.0.5_amd64.AppImage) | Universal Portable |
| **Linux** | 64-bit (`x86_64`) | [**MatterPackr Debian Package (.deb)**](https://github.com/Z-Sofware-Labs/MatterPackr/releases/latest/download/matterpackr_1.0.5_amd64.deb) | Ubuntu / Debian / Mint |
...
- **Windows NSIS Installer**: `src-tauri/target/release/bundle/nsis/MatterPackr_1.0.5_x64-setup.exe`
- **Windows MSI Package**: `src-tauri/target/release/bundle/msi/MatterPackr_1.0.5_x64_en-US.msi`
